...
if (!function_exists('web_developer_elementor_enqueue_scripts')) {
	...
	function web_developer_elementor_enqueue_scripts() {
		...
		wp_add_inline_style( 'web-developer-elementor-style',$web_developer_elementor_theme_custom_setting_css );
...
if (!function_exists('web_developer_elementor_after_setup_theme')) {
	...
	function web_developer_elementor_after_setup_theme() {
		...
		load_theme_textdomain( 'web-developer-elementor', get_template_directory() . '/languages' );
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			...
			echo '<div class="notice-content">';
				echo '<h2>'. esc_html__( 'Welcome to WPElemento', 'web-developer-elementor' ) .'</h2>';
				echo '<p>'. esc_html__( 'Thank you for choosing Web Developer Elementor theme .To setup the theme, please visit the get started page.', 'web-developer-elementor' ) .'</p>';
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=web_developer_elementor_about' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'web-developer-elementor' ) .'</a></span>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
}
...
if (!function_exists('web_developer_elementor_widgets_init')) {
	...
	function web_developer_elementor_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Page Sidebar','web-developer-elementor'),
			'id'   => 'sidebar-2',
			'description'   => esc_html__('This sidebar will be shown on pages.', 'web-developer-elementor'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar three','web-developer-elementor'),
			'id'   => 'sidebar-3',
			'description'   => esc_html__('This sidebar will be shown on blog pages.', 'web-developer-elementor'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 1','web-developer-elementor'),
			'id'   => 'footer1-sidebar',
			'description'   => esc_html__('It appears in the footer 1.', 'web-developer-elementor'),
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 2','web-developer-elementor'),
			'id'   => 'footer2-sidebar',
			'description'   => esc_html__('It appears in the footer 2.', 'web-developer-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 3','web-developer-elementor'),
			'id'   => 'footer3-sidebar',
			'description'   => esc_html__('It appears in the footer 3.', 'web-developer-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 4','web-developer-elementor'),
			'id'   => 'footer4-sidebar',
			'description'   => esc_html__('It appears in the footer 4.', 'web-developer-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
 ...
 */
 ...
 function web_developer_elementor_logo_resizer() {

    $web_developer_elementor_theme_logo_size_css = '';
	$web_developer_elementor_theme_custom_logo_id = get_theme_mod( 'custom_logo' );
	$web_developer_elementor_theme_logo_width = get_theme_mod( 'web_developer_elementor_logo_resizer', 150 ); // Default to 200 if not set
	$web_developer_elementor_theme_logo_height = $web_developer_elementor_theme_logo_width * 0.5;

	if ( $web_developer_elementor_theme_custom_logo_id ) {
		$web_developer_elementor_theme_logo_data = wp_get_attachment_image_src( $web_developer_elementor_theme_custom_logo_id, 'full' );
		$web_developer_elementor_theme_logo_url = $web_developer_elementor_theme_logo_data[0];
		$web_developer_elementor_theme_original_width = $web_developer_elementor_theme_logo_data[1];
		$web_developer_elementor_theme_original_height = $web_developer_elementor_theme_logo_data[2];
		$web_developer_elementor_theme_aspect_ratio = $web_developer_elementor_theme_original_height / $web_developer_elementor_theme_original_width;
		$web_developer_elementor_theme_logo_height = $web_developer_elementor_theme_logo_width * $web_developer_elementor_theme_aspect_ratio;
   
	}
	$web_developer_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($web_developer_elementor_theme_logo_height).'px !important;
			width: '.esc_attr($web_developer_elementor_theme_logo_width).'px !important;
		}
	';
    wp_add_inline_style( 'web-developer-elementor-style',$web_developer_elementor_theme_logo_size_css );

}

add_action( 'wp_enqueue_scripts', 'web_developer_elementor_logo_resizer' );
...
if (!function_exists('web_developer_elementor_loop_columns')) {
	function web_developer_elementor_loop_columns() {
		return get_theme_mod( 'web_developer_elementor_products_per_row', '3' ); 
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'web_developer_elementor_products_per_page' );
function web_developer_elementor_products_per_page( $cols ) {
  	return  get_theme_mod( 'web_developer_elementor_products_per_page',9);
}
...
function web_developer_elementor_customize_css() {
	?>
	<?php if ( 'right' == get_theme_mod( 'web_developer_elementor_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale {
			left: auto; right: 10px;
		}
		</style>
	<?php elseif ( 'left' == get_theme_mod( 'web_developer_elementor_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale{
...
define('WEB_DEVELOPER_ELEMENTOR_FREE_THEME_DOC',__('https://preview.wpelemento.com/theme-documentation/web-developer-elementor/','web-developer-elementor'));
...
define('WEB_DEVELOPER_ELEMENTOR_BUY_NOW',__('https://www.wpelemento.com/products/web-development-wordpress-theme','web-developer-elementor'));
define('WEB_DEVELOPER_ELEMENTOR_LIVE_DEMO',__('https://preview.wpelemento.com/web-developer-elementor/','web-developer-elementor'));
define('WEB_DEVELOPER_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/products/wordpress-theme-bundle','web-developer-elementor'));
